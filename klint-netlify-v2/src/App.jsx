...
const BRAND = `Du är en AI-assistent som hjälper med innehållsproduktion för ett nordiskt VC-bolag fokuserat på AI-infrastruktur och Deep Tech.
...
POSITIONERING:
- AI-infrastruktur, AI och Deep Tech VC/PE
  ...
  async function scanNews() {
    ...
    try {
      ...
      const ranked = await askClaude(keys.claude,
        `Här är ${Math.min(rawArticles.length, 25)} nyhetsartiklar. Ranka de 10 viktigaste för ett nordiskt VC-bolag fokuserat på AI-infrastruktur och Deep Tech.

Bedöm baserat på:
- Relevans för AI-infrastruktur, AI-modeller, Deep Tech, VC/PE
